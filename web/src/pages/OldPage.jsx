    ...
    <div className="page old-page">
      <header className="nav">
        ...
        <nav className="nav-links">
          <a href="#old-how">How it works</a>
          <a href="#old-features">Features</a>
          <a href="#old-demo">Demo</a>
          <a href="#old-providers">Providers</a>
      ...
      <main>
        <section className="hero">
          <div className="hero-content">
            ...
            <div className="cta-row">
              <a className="btn primary" href="#old-contact">
                Get the pre-launch test version
              </a>
              <a className="btn secondary" href="#old-providers">
        ...
        <section className="section alt" id="old-how">
        ...
        <section className="section" id="old-features">
          <div className="section-header">
        ...
        <section className="section demo alt" id="old-demo">
          <div className="section-header">
        ...
        <section className="section investors" id="old-investors">
          <div className="section-header">
          ...
          <div className="investor-card">
            ...
            <a className="btn secondary" href="#old-contact">
              Contact the founders
            </a>
          </div>
        </section>

        <section className="section providers alt" id="old-providers">
          <div className="section-header">
        ...
        <section className="section founding" id="old-contact">
          <div className="section-header">
